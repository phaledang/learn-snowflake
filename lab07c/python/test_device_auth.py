#!/usr/bin/env python3
"""
Test script for device code Azure AD authentication
"""
...
def test_device_code_authentication():
    """Test the device code authentication flow"""
    print("🧪 Testing Device Code Azure AD Authentication")
    print("=" * 50)
    ...
    print("🔐 No cached token found. Starting device code login...")
    
    # Test device code login
    success, message = auth.login_device_code()
...
if __name__ == "__main__":
    try:
        success = test_device_code_authentication()
        if success:
            print("\n🎉 Device code authentication test passed!")
        else:
            print("\n💥 Device code authentication test failed!")
            sys.exit(1)
